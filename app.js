...
newUserBtn.addEventListener('click',()=>{
    ...
    isEdit = false
    imgInput.src = "./images/Profile-icon.png"
    form.reset()
})

//added image to imagebox
...
//showing information in screen fetching from localstorage
function showInfo(){
...
//read information using read button
...
//edit information using edit button
...
//display data in console application
form.addEventListener('submit', (e)=> {
    e.preventDefault()

    const information = {
        picture: imgInput.src == undefined ? "./images/Profile-icon.png" : imgInput.src,
...
function readInfo(pic,name,age,city,email,phone,post,sDate){
    document.querySelector('.showImg').src = pic,
    document.querySelector('#showImg').value = name,
    document.querySelector('#showAge').value = age,
    document.querySelector('#showCity').value = city,
    document.querySelector('#showEmail').value = email,
    document.querySelector('#showPhone').value = phone,
